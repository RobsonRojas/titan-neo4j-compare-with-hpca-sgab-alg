...
public class Main {
    ...
    private void run(int amstra, int escala, boolean blk1, boolean blk2, boolean blk3, boolean blk4, int numAmstrK4) {
        ...
        try {
            ...
            graphdb = new Neo4j(log);
            
            // kerne1
            if (execK1 && graphdb.conectarRemote("127.0.0.1")) {
            ...
            if (execK2 && graphdb.conectarRemote("127.0.0.1")) {
                // kernel 2
                System.out.println();
                System.out.println();
            ...
            if (execK3 && graphdb.conectarRemote("127.0.0.1")) {
                // kernel 3
                System.out.println();
                System.out.println();
            ...
            if (execK4 && graphdb.conectarRemote("127.0.0.1")) {
                // arquivo de amostras
